...
export function CloudRaining01Solid({
  children,
  ...props
  ...
  return (
    <svg viewBox="0 0 24 24" fill="none" {...props}>
      ...
      />
      <path
        d="M12 1C8.7764 1 6.0632 3.17816 5.24923 6.14303C2.8139 6.70961 1 8.8925 1 11.5C1 14.5376 3.46243 17 6.5 17H17.5C20.5376 17 23 14.5376 23 11.5C23 8.8925 21.1861 6.70961 18.7508 6.14303C17.9368 3.17816 15.2236 1 12 1Z"
        fill="currentColor"
      />
      {children}
    </svg>
